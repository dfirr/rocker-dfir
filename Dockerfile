...
COPY corp-ca-entrypoint.sh /usr/local/bin/corp-ca-entrypoint.sh
RUN chmod +x /usr/local/bin/corp-ca-entrypoint.sh
ENTRYPOINT ["/usr/local/bin/corp-ca-entrypoint.sh"]
